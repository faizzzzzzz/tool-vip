...
echo
echo $red"==================="$red" ==================="
echo $i""$pu"  AUTHOR  :  KING RICODE  "$red"                   "
echo $i""$pu"  WhatsApp:  085220205961"$ku"                "
echo $i""$pu"  GMAIL   : FFFFFFFFF@GMAIL.COM"$i"    "
echo $i""$pu"  YOUTUBE :  YouTube rizki XD "$i"                "
echo $pu"==================="$pu" ==================="
echo
...
sleep 2
echo $red"10000000000000000000"
sleep 2
echo $pu"Silahkan di pakai semoga bermanfaat Buat anda"
sleep 2
echo $red"jika script eror bisa hubungi"
sleep 2
echo $"Facebook :"$i"RAHASIA "
echo $pu"YouTube  :"$i" "
echo $red"WhatsApp :"$i" 085220205961"
sleep 2
echo $pu"menggunakan = menghargai"
sleep 2
echo $red"suscribe chanel rizki XD"
exit
fi
